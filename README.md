...
Семантичность[](https://github.com/qostua## "Отличаю section от article, а также кнопку от ссылки"), доступность[*](. "Следаю заветам Вадима Макеева: использую aria-label и не только"), ретиновая и адаптивная графика[*](. "А также WebP с дегродацией")
